...
func (client *rateLimitingClient) CreateChatCompletion(ctx context.Context, req openai.ChatCompletionRequest) (openai.ChatCompletionResponse, error) {
	log.WithField("req", req).Info("CreateChatCompletion")
...
func (client *rateLimitingClient) CreateChatCompletionStream(ctx context.Context, req openai.ChatCompletionRequest) (*openai.ChatCompletionStream, error) {
	log.WithField("req", req).Info("CreateChatCompletionStream")
	if err := client.limiter.Wait(ctx); err != nil {
		return nil, err
	}
